...
namespace CellCounter.Wpf.Model;
...
public class PythonServer
{
    ...
    public PythonEnvCheckResult CheckPythonEnvironment()
    {
        ...
        string devServer = Path.Combine(devRoot, "CellCounter.Py", "server.py");
        string devInfo = Path.Combine(devRoot, "CellCounter.Py", "get_cellpose_info.py");
        ...
        if (File.Exists(devPython) && File.Exists(devServer) && File.Exists(devInfo))
        {
            ...
            _infoScript = devInfo;
            _workingDir = Path.Combine(devRoot, "CellCounter.Py");
